...
export function ImageManager({
  ...
  const handleFiles = useCallback(
    ...
    [uploadedImages, fetchStoredImages],
  )
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">JPEG, PNG, WebP, SVG • Max 10MB each</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {storedImages.map((image, index) => (
                  ...
                  >
                    ...
                    {/* Image Info */}
                    <div className="p-3">
                      <div className="text-xs text-gray-500 dark:text-gray-400 truncate mb-1">{image.filename}</div>
